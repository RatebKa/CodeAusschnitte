...
#This File contains the complete code for loading the data, defining the KAN model, training, validation, and testing. The KAN Model is implemented from scratch without using any external libraries for the KAN architecture.
...
# Define the KAN model from the original paper explaining the KAN architecture
